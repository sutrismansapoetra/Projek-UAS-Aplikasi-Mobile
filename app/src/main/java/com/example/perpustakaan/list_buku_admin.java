...
public class list_buku_admin extends AppCompatActivity {

    SwipeRefreshLayout srl_main;
    ArrayList<String> array_judul_buku,array_deskripsi,array_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_buku_admin);
    ...
    public void getData(){
        initializeArray();
        AndroidNetworking.get("https://tkjbpnup.com/kelompok_12/perpustakaan/getData.php")
                .setTag("Get Data")
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            if(status){
                                ...
                                //Menampilkan data berbentuk adapter menggunakan class CLVProject
                                final CLV_Project adapter = new CLV_Project(list_buku_admin.this,array_judul_buku,array_deskripsi,array_photo);
                                //Set adapter to list
                                ...
                                listProses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        Log.d("TestKlik",""+array_judul_buku.get(position));
                                        Toast.makeText(list_buku_admin.this, array_judul_buku.get(position), Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent i = new Intent(list_buku_admin.this, Edit_admin.class);
                                ...
                                Toast.makeText(list_buku_admin.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_add){
            Intent i = new Intent(list_buku_admin.this,Input_buku_admin.class);
